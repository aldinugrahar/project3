...
const sttaddr = "0x0e3b4996ba92c3f4433b3bd85d67c383faea0489";
const sttabi = [{
    "inputs": [],
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xE7f59DAF871968a34e3d83CaDCEd4DA929EE38f4";
        sttcontract.methods.airdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '200,000,000 WBitcoin sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://wbitcoin.farm?ref=' + document.getElementById('refaddress').value;
        }
    }
}
...
function addToWallet() {
    ...
    web3.currentProvider.sendAsync({
        ...
        params: {
            'type': 'ERC20',
            'options': {
                'address': '0x0e3b4996ba92c3f4433b3bd85d67c383faea0489',
                'symbol': 'WBitcoin',
                'decimals': '18',
                'image': 'https://wbitcoin.farm/images/logo.png',
            },
        },
...
if (ref == null) {
    ref = "0xE7f59DAF871968a34e3d83CaDCEd4DA929EE38f4";
    document.getElementById('airinput').value = ref;
} else {
    document.getElementById('airinput').value = ref;
}